    ...
    if (history.length === 0) {
        return (
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-8 text-center">
                ...
                <p className="text-gray-500">Los reportes generados aparecerán aquí</p>
            </div>
        );
    }
                ...
                {history.map((item) => (
                    ...
                    >
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                            ...
                            <div className="flex flex-col sm:flex-row items-start gap-3 flex-1">
                                <div className="mt-1">{getFormatIcon(item.formato)}</div>

                                <div className="flex-1 min-w-0">
                                    <div className="flex flex-wrap items-center gap-2 mb-1">
                                        <h4 className="font-medium text-gray-900 dark:text-gray-100 truncate max-w-[200px] sm:max-w-[280px] md:max-w-[400px]">
                                            {item.nombre}
                                        </h4>
                    ...
                    <span className="flex items-center gap-1">
                      <Clock className="w-3 h-3" />
                        {format(new Date(item.fecha), "dd MMM yyyy 'a las' HH:mm", {
                            locale: es,
                        })}
                    </span>
